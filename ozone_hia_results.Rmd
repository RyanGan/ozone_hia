...
*Pop at Risk:* These estimates come from the 2010 census and are state-level population counts of persons under the age of 18. The counts are further stratified by sex, and by white/black race, and Hispanic ethnicity. 
...
ggsave("./data/ozone_map.png", width = 6, height = 4, units = "in")
...
smoke_days_map
# smoke map
ggsave("./data/smoke_days_map.png", width = 7, height = 4, units = "in")
...
# save 6 inch by 4 inch
ggsave("./data/period_y_map.png", width = 6, height = 4, units = "in")
...
prop_map
# save image
ggsave("./data/proportion_map.png", width = 6, height = 4, units = "in")
