...
summary(filter(daily_df, group == "Marginal" & state != "state_sum"))
period_df <- read_csv("./data/mc_estimates/mc_period.csv")
# add median and IQR summaries to markdown
summary(filter(period_df, group == "Hispanic" & state != "state_sum"))

prop_df <- read_csv("./data/mc_estimates/mc_prop_100k.csv")
summary(filter(prop_df, group == "Hispanic" & state != "state_sum"))
