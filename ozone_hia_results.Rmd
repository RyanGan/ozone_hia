...
ozone_map <- ggplot(state_map_df, aes(x = long, y = lat, group=group)) +
  ...
  geom_polygon(data = state_vals_map_df, aes(fill = delta_o3), alpha = 0.7) +
  scale_fill_gradient(expression(paste(Delta, "O"[3])), high = '#f83600', low = '#00223E',
                      breaks = c(-2,0,2,4,6,8,10,12,14,16),
...
### Map of State Average Number of Smoky Days (2005-2014)
...
smoke_days_map <- ggplot(state_map_df, aes(x = long, y = lat, group=group)) +
  ...
  scale_fill_gradient("State average \nnumber of \nsmoky days \n2005-2014", low = '#EFEFBB', 
                      high = '#c21500',
